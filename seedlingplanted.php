...
<div class="main-content">
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <p>Monitor and track all seedling planting activities across different areas</p>
        </div>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <?php if (!empty($paginatedData)): ?>
                    <?php foreach ($paginatedData as $index => $record): 
                    ...
                    <tr style="animation-delay: <?php echo $index * 0.05; ?>s">
                        ...
                        <td>
                            <span class="badge bg-success text-white">
                                <?= htmlspecialchars($record['variety'] ?? '') ?>
                            </span>
                        </td>
                        <td>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="5" class="text-center py-5">
                            <i class="fas fa-tree" style="font-size: 48px; color: #cbd5e0; margin-bottom: 15px;"></i>
                            <br>
                            <h5 style="color: #718096;">No planting records found</h5>
                            <p style="color: #a0aec0;">Start adding seedling planting records to see them here</p>
                        </td>
                    </tr>
                <?php endif; ?>
            </tbody>
